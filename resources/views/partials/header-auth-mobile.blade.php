@guest
    ...
    <a href="{{ route('register') }}"
        class="flex items-center justify-center gap-2 mt-2 px-4 py-2 text-sm font-semibold text-white bg-emerald-600 rounded hover:bg-emerald-700">
...
@else
    ...
    <a href="{{ route("filament.{$panelId}.pages.dashboard") }}"
        class="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-emerald-600 rounded hover:bg-emerald-700">
