...
class CreatePharmacyProduct extends CreateRecord
{
        ...
        return $form
            ->schema([
                Select::make('medication_variant_id')
                    ...
                    ->required()
                    ->rules([
                        Rule::unique('pharmacy_products', 'medication_variant_id')
                            ->where('pharmacy_id', Auth::user()->pharmacy_id),
                    ])
                    ->validationMessages([
                        'unique' => 'This product variant is already in your pharmacy\'s inventory.',
                    ])
                    ->createOptionForm([
    ...
    {
        // Dispatch an event after the product is created.
        ProductCreated::dispatch($this->getRecord());
    }
}
