...
class AnnouncementResource extends Resource
{
    ...
    {
        if ($record->is_active) {
            // If the saved record is active, find all *other* active announcements and deactivate them.
            Announcement::where('id', '!=', $record->id)->where('is_active', true)->update(['is_active' => false]);
        }
    }
}
